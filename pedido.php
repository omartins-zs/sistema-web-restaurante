    ...
    <div class="container">
        <form action="cadastrar_pedido.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="qtd_produto" name="qtd_produto" placeholder="Digite a quantidade" maxlength="10">
            </div>
            <div class="form-group">
                <label for="obs_produto">Observação:</label>
                <input type="text" class="form-control" name="obs_produto" id="obs_produto">
            </div>
            <div class="form-group">
                <label for="preco_produto">Preco unitário:</label>
